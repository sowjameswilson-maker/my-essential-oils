...
export default async function ProductPage({ params }) {
  ...
  if (!oil) return <div className="p-20 text-center">Product not found</div>;
      ...
      <main className="min-h-screen bg-stone-50 py-12 md:py-20 px-6">
        <div className="max-w-4xl mx-auto">
           {/* Back to Shop Button */}
            ...
            <span className="text-[10px] uppercase tracking-[0.2em] font-bold">Back to Shop</span>
            </Link>
          ...
          <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-stone-100 flex flex-col md:flex-row mb-8">
            ...
            <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
              <span className="text-emerald-700 text-[10px] uppercase tracking-[0.2em] font-bold mb-2">{oil.type}</span>
              <h1 className="text-3xl md:text-4xl font-serif text-emerald-900 mb-2">{oil.name}</h1>
              
              <p className="text-xl font-medium text-stone-800 mb-6">${oil.price}</p>
